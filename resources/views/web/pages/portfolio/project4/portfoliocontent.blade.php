    ...
    <section id="portfolio-details" class="portfolio-details section" style="padding: 60px 0;">
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            <div class="row gy-4">
                    ...
                    <div class="portfolio-details-slider swiper init-swiper"
                        ...
                        <div class="swiper-wrapper align-items-center">
                            ...
                            <div class="swiper-slide">
                                <img src="{{ asset('img/portfolio/project-1 (8).png') }}" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img src="{{ asset('img/portfolio/project-1 (811).png') }}" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img src="{{ asset('img/portfolio/project-1 (4).jpg') }}" alt="">
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="portfolio-info" data-aos="fade-up" data-aos-delay="200"
                        ...
                        <ul>
                            <li><strong>Project Title</strong>: E-commerce site</li>
                            ...
                            <li> <a href="https://shahid-raza7463.github.io/E-commerce-website-single-page-/"
                                    target="_blank">https://ecommerce.com</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="portfolio-description" data-aos="fade-up" data-aos-delay="300"
                ...
                <h5><strong>E-commerce site:</strong></h5>
                <p>
                    This project is a single-page E-commerce site where users can browse and view products.
                    The site is designed to provide a smooth and user-friendly experience, allowing customers to
                    explore product details, including images, descriptions, and pricing. Although it currently
                    focuses on product display, future enhancements will enable complete shopping
                    functionalities, such as adding items to the cart and making purchases.
                </p>
