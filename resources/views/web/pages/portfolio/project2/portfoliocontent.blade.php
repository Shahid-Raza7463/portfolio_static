    ...
    <section id="portfolio-details" class="portfolio-details section" style="padding: 60px 0;">
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            <div class="row gy-4">
                    ...
                    <div class="portfolio-details-slider swiper init-swiper"
                        ...
                        <div class="swiper-wrapper align-items-center">
                            ...
                            <div class="swiper-slide">
                                <img src="{{ asset('img/portfolio/project-1 (6).png') }}" alt="">
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ asset('img/portfolio/project-1 (61).png') }}" alt="">
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="portfolio-info" data-aos="fade-up" data-aos-delay="200"
                        ...
                        <ul>
                            <li><strong>Project Title</strong>: Analog Digital Clock</li>
                            ...
                            <li><a href="https://shahid-raza7463.github.io/Analog-digital-clock/"
                                    target="_blank">https://Digitalclock.com</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="portfolio-description" data-aos="fade-up" data-aos-delay="300"
                ...
                <h5><strong>Analog Digital Clock:</strong></h5>
                <p>
                    This project showcases an Analog Clock, featuring a watch image with three hands: hour,
                    minute, and second. The design emphasizes the classic analog timekeeping method, providing a
                    visually appealing and accurate representation of time through its traditional mechanical
                    interface.
                </p>
