<main class="main">
    ...
    <section id="portfolio-details" class="portfolio-details section" style="padding: 60px 0;">
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            <div class="row gy-4">
                    ...
                    <div class="portfolio-details-slider swiper init-swiper"
                        ...
                        <div class="swiper-wrapper align-items-center">
                            ...
                            <div class="swiper-slide">
                                <img src="{{ asset('img/portfolio/project-linktester (1).png') }}" alt="">
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ asset('img/portfolio/project-linktester (2).png') }}" alt="">
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ asset('img/portfolio/project-linktester (3).png') }}" alt="">
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ asset('img/portfolio/project-linktester (4).png') }}" alt="">
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ asset('img/portfolio/project-linktester (5).png') }}" alt="">
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ asset('img/portfolio/project-linktester (6).png') }}" alt="">
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ asset('img/portfolio/project-linktester (7).png') }}" alt="">
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="portfolio-info" data-aos="fade-up" data-aos-delay="200"
                        ...
                        <ul>
                            <li><strong>Project Title</strong>: Linktester</li>
                            <li><strong>Category</strong>: Web design</li>
                            <li><strong>Company</strong>: TrakAff-Affiliate Tracking Software</li>
                            {{-- Capitall India Private Limited --}}
          ...
          <li><a href="https://linkchecker.infinityfreeapp.com/"
                                    target="_blank">https://www.linkchecker.infinityfreeapp.com</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="portfolio-description" data-aos="fade-up" data-aos-delay="300"
                ...
                <h5><strong>Linktester:</strong></h5>
                <p>
                    This project, Linktester, is designed to track and test URLs. It allows users to input any
                    URL and checks how many redirection URLs are associated with it. The system then displays
                    the redirection results in a dedicated section. Additionally, it generates a unique URL that
                    can be shared with others, allowing anyone with the link to view the results. This tool is
                    useful for analyzing URL redirects and sharing the insights in a user-friendly format.
                </p>
