    ...
    <section id="portfolio-details" class="portfolio-details section" style="padding: 60px 0;">
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            <div class="row gy-4">
                    ...
                    <div class="portfolio-details-slider swiper init-swiper"
                        ...
                        <div class="swiper-wrapper align-items-center">
                            ...
                            <div class="swiper-slide">
                                <img src="{{ asset('img/portfolio/project-login (3).jpg') }}" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img src="{{ asset('img/portfolio/project-login (2).jpg') }}" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img src="{{ asset('img/portfolio/project-login (1).jpg') }}" alt="">
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="portfolio-info" data-aos="fade-up" data-aos-delay="200"
                        ...
                        <ul>
                            <li><strong>Project Title</strong>: Login System</li>
                            ...
                            <li><a href="https://shahid-raza7463.github.io/Login-system/"
                                    target="_blank">https://loginsystem.com</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="portfolio-description" data-aos="fade-up" data-aos-delay="300"
                ...
                <h5><strong>Login System:</strong></h5>
                <p>
                    This project is a robust Login System that allows users to securely log in, sign up, and
                    recover their password through the "Forgot Password" feature. It ensures user authentication
                    and offers a simple, user-friendly interface for managing user credentials. The system is
                    designed with security best practices to protect user data and provides a seamless
                    experience for account creation and login functionality.
                </p>
